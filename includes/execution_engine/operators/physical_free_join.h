...
namespace free_join {
    ...
    class PhysicalFreeJoin : public PhysicalNaryOperator {
    ...
    public:
        ...
        explicit PhysicalFreeJoin(int16_t src, LogicalOperatorTree *tree) :
                plan(tree),
                rows_read(0),
                total_rows(0),
                current_output(0),
        ...
        bool next() override {
            if (first_call) {
                ...
                for (auto i = 0u; i < children.size(); ++i) {
                    ...
                    auto &current_physical_schema = (i == 0) ? leftmost_physical_schema : physical_schema;
                    ...
                    if (i == 0) {
                        leftmost_src_idx = child_src_idx;
                        continue;
                    }
